...
const requestCloseAccount = async (to, account, language) => {
  i18n.changeLanguage(language)
  const subject = i18n.t('requestCloseAccount.subject')
                ...
                <td align="center" bgcolor="#f6f6f6">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600 px;">
                    ...
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                      <p style="margin: 0;">
                        ${i18n.t('requestCloseAccount.paragraph')}
                        <br><br>
                        ${i18n.t('requestCloseAccount.paragraph2')}
                        <br><br>
                        ${i18n.t('requestCloseAccount.paragraph3')}
                        <br><br>
                        ${i18n
...
const reopenAccount = async (to, language) => {
  i18n.changeLanguage(language)
  const subject = i18n.t('reopenAccount.subject')
                ...
                <td align="center" bgcolor="#f6f6f6">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600 px;">
                    ...
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                      <p style="margin: 0;">
                        ${i18n.t('reopenAccount.paragraph')}
                        <br><br>
                        ${i18n.t('reopenAccount.paragraph2')}
                      </p>
                      </td>
                    </tr>
                    <tr>
                ...
                <td align="center" bgcolor="#f6f6f6">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600 px;">
                    ...
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                      <p style="margin: 0;">
                        ${i18n.t('closeAccountDayRemaining.paragraph')}
                        <br><br>
                        ${i18n.t('closeAccountDayRemaining.paragraph2')}
                        <br><br>
                ...
                <td align="center" bgcolor="#f6f6f6">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600 px;">
                    ...
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                      <p style="margin: 0;">
                        ${i18n.t('closeAccountWeekRemaining.paragraph')}
                        <br><br>
                ...
                <td align="center" bgcolor="#f6f6f6">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600 px;">
                    ...
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                      <p style="margin: 0;">
                        ${i18n.t('closeAccountMonthRemaining.paragraph')}
                        <br><br>
...
const closeAccount = async (to, language) => {
  i18n.changeLanguage(language)
  const subject = i18n.t('closeAccount.subject')
                ...
                <td align="center" bgcolor="#f6f6f6">
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600 px;">
                    ...
                    <tr>
                      <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
                      <p style="margin: 0;">
                        ${i18n.t('closeAccount.paragraph')}
                        <br><br>
                        ${i18n.t('closeAccount.paragraph2')}
                        <br><br>
                        ${i18n.t('closeAccount.paragraph3')}
                        <br><br>
                        ${i18n.t('closeAccount.paragraph4')}
                      </p>
                      </td>
                    </tr>
                    <tr>
...
module.exports = {
  ...
  requestCloseAccount,
  reopenAccount,
  closeAccountDayRemaining,
  closeAccountWeekRemaining,
  closeAccountMonthRemaining,
  closeAccount
}
